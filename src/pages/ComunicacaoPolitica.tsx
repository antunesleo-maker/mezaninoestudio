        ...
        >
          ...
          <div className="w-full px-6 md:px-12 lg:px-16 relative z-10 flex-none md:flex-1 flex items-start justify-start py-8 md:py-24 md:items-center md:justify-start">
            <div className="max-w-xl">
              ...
              <Reveal delay={150}>
                <h1
                  className="heading-display text-white mb-1 md:mb-8 !text-[1.1rem] sm:!text-[2rem] md:!text-[3rem] !leading-[1.15]"
              ...
              <Reveal delay={300}>
                <p
                  className="body-editorial !text-white mb-1 md:mb-10 max-w-lg text-xs md:text-base !leading-[1.3]"

...
const services = [
  ...
  },
  {
    ...
    description:
      "Produção de conteúdo em campo para campanhas, com captação de fotos e vídeos e edição ágil para publicação nas redes sociais durante caminhadas, carreatas, visitas, plenárias, comícios e demais atividades eleitorais.",
  },
];
  ...
  return (
    <>
      ...
      <main id="top">
        {/* HERO */}
        <section
          className="relative h-[87vh] md:min-h-screen flex flex-col justify-start md:justify-center pt-4 md:pt-28"
        >
          {/* Desktop background */}
          <div
          ...
          <div className="w-full px-6 md:px-12 lg:px-16 relative z-10 flex h-[40%] md:h-auto md:flex-1 items-start justify-start md:items-center md:justify-start pt-20 pb-4 md:py-24">
            <div className="max-w-xl">
              ...
              <Reveal delay={150}>
                <h1
                  className="heading-display text-white mb-6 md:mb-8 !text-[2rem] sm:!text-[2rem] md:!text-[4rem] !leading-[1.15] md:!leading-[1.15]"
              ...
              <Reveal delay={300}>
                <p
                  className="body-editorial !text-white mb-7 md:mb-10 max-w-lg text-sm md:text-lg !leading-[1.25]"

        ...
        >
          ...
          <div className="w-full px-6 md:px-12 lg:px-16 relative z-10 flex h-[40%] md:h-auto md:flex-1 items-start justify-start md:items-center md:justify-start pt-20 pb-4 md:py-24">
            <div className="max-w-xl">
              ...
              <Reveal delay={150}>
                <h1
                  className="heading-display text-white mb-6 md:mb-8 !text-[1.65rem] sm:!text-[2rem] md:!text-[3rem] !leading-[1.3]"
              ...
              <Reveal delay={300}>
                <p
                  className="body-editorial !text-white mb-7 md:mb-10 max-w-lg text-sm md:text-base !leading-[1.35]"

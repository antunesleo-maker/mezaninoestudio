  ...
  return (
    <>
      ...
      <main id="top">
        {/* HERO */}
        <section
          className="relative aspect-[9/16] md:aspect-auto md:min-h-screen flex flex-col justify-start md:justify-center pt-10 md:pt-28"
        >
          {/* Desktop background */}
          <div
          ...
          <div className="w-full px-6 md:px-12 lg:px-16 relative z-10 flex-none md:flex-1 flex items-start justify-start py-8 md:py-24 md:items-center md:justify-start">
            <div className="max-w-xl">
              ...
              <Reveal delay={150}>
                <h1
                  className="heading-display text-white mb-2 md:mb-8 !text-[1.15rem] sm:!text-[2rem] md:!text-[3rem] !leading-[1.15]"
              ...
              <Reveal delay={300}>
                <p
                  className="body-editorial !text-white mb-2 md:mb-10 max-w-lg text-xs md:text-base !leading-[1.4]"
